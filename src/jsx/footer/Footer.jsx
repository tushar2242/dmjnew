            ...
            <footer className="">
              <div className="row">
                <div className="col-md-3 mt-3">
                  ...
                  Elevate your style with exquisite jewelry. Discover timeless pieces for every occasion on our curated jewelry website.
                  </p>

                  <h6 style={{color:'#abdbe3' , fontSize:'18px'}} className="mt-4"><b>Social Media</b></h6>
                ...
                <h6 style={{color:'#abdbe3' , fontSize:'18px'}} className="mt-4"><b>E-Commerce</b></h6>
                <ul className="list-unstyled d-flex">
                  <li className="ms-3">
                    <NavLink
                      className="link-dark"
                  ...
                  <li className="ms-3">
                    <NavLink
                      ...
                      to="/"
                    >
                      <img src={flipkart} alt="icon" className="ecomrce-icon" />
                    </NavLink>
                  </li>
                  <li className="ms-3">
                    <NavLink
                    ...
                    >
                      <img src={indiamart} alt="icon" className="ecomrce-icon" />
                    </NavLink>
                  </li>
                </ul>
                </div>
